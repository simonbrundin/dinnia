import { version, getCurrentInstance, defineComponent, computed, ref, h, resolveComponent, reactive, isReadonly, useSSRContext, createApp, toRef, isRef, mergeProps, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, unref, inject } from 'vue';
...
const vueuse_head_plugin_SiCv9sXWBa = defineNuxtPlugin((nuxtApp) => {
...
const router_01Pvl0ttUa = defineNuxtPlugin((nuxtApp) => {
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui-templates@1.1.1/node_modules/@nuxt/ui-templates/dist/templates/welcome.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4ef07d36"]]);
const _sfc_main$1 = {};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component-a9b9b051.mjs').then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import('./_nuxt/island-renderer-52e588eb.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.1.2/node_modules/nuxt/dist/app/components/nuxt-root.vue");
